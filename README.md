![og-image](https://rozne-backpack.s3.us-west-2.amazonaws.com/Rozne-nextjs-supabase-graphql-og.jpg)

> We are Keep developing the project.

# Rozne - E-commerce with Custom CMS

[Rozne](https://rozne.hugo-coding.com) is a cutting-edge e-commerce platform equipped with a custom Content Management System (CMS), designed to provide an exceptional online shopping experience. Built using the latest web technologies such as Next.js 14, GraphQL, Supabase, Drizzle, ShadcnUI, and TailwindCSS, Rozne offers seamless, fast, and responsive interactions across all devices.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/yourusername/rozne.git
   ```
...
We welcome contributions to Rozne! Please read our Contributing Guide for details on our code of conduct and the process for submitting pull requests to us.

## License

Rozne is licensed under the MIT License. See the license file for more information.

## Acknowledgments

- Special thanks to all libraries and frameworks that made Rozne possible.
- Shoutout to the community for supporting and using Rozne.
