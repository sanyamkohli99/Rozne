...
export const promoCards = pgTable("promo_cards", {
  ...
  catchphraseDesc: text("catchphrase_desc"),
  createdAt: timestamp("created_at", { withTimezone: true })
    .defaultNow()
    .notNull(),
});

export type SelectPromoCards = InferSelectModel<typeof promoCards>;
export type InsertPromoCards = InferInsertModel<typeof promoCards>;
