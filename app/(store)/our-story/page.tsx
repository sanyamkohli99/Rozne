      ...
      <Shell>
        <div className="max-w-3xl mx-auto py-16 space-y-10">
          ...
          <div className="pt-4">
            <Link
              href="/shop"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 h-11 px-8"
            >
              Shop the collection
            </Link>
          </div>
